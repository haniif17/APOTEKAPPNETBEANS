...
//        loadTableData();
    ...
    private void btn_cariObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cariObatActionPerformed
        ...
        model.setRowCount(0); // ngosongin baris tabel, biar ganabrak
    ...
    private void loadTableData() {
        if (table_cariObat == null || table_cariObat.getModel() == null) {
            System.err.println("Error: Table belum terinisiasi, coba dicek kembali");
            JOptionPane.showMessageDialog(this, "Tabel belum siap.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            conn = DatabaseController.getConnection(); // koneksi ke db
